  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
        ...
        {senderConfig && senderConfig.senderIds && (
          <div>
            ...
            <div style={{ 
              ...
              <p><strong>Primary Sender ID:</strong> {senderConfig.primary}</p>
              <p><strong>Active Sender ID:</strong> {senderConfig.active}</p>
            </div>
          </div>
        )}
      ...
      <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '4px' }}>
        ...
        {market && <p><strong>Market:</strong> {market}</p>}
        {program && <p><strong>Program:</strong> {program}</p>}
        {selectedSenderId && <p><strong>Selected Sender ID:</strong> {selectedSenderId}</p>}
        {senderConfig && (
          <div style={{ marginTop: '10px' }}>
            <p><strong>Available Sender IDs:</strong> {senderConfig.senderIds.join(', ')}</p>
            <p><strong>Primary:</strong> {senderConfig.primary} | <strong>Active:</strong> {senderConfig.active}</p>
          </div>
        )}
      </div>
    </div>
